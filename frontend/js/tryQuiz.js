function tryQuiz(){
    $('#quiz').bind('click',function(){
        ...
        $('#Content').append((
            ...
            "<button type='button' style='display:none' id = 'triggerQuiz' class='btn btn-primary' data-toggle='modal' data-target='#exampleModal'>"+
            "  Launch demo modal"+
            "</button>"+
            ""+
            "<!-- Modal -->"+
...
"<div id = 'final'></div>"+
            ...
            "        <button type='button' id = 'closeLevel1' class='btn btn-secondary'>Close</button>"+
            "        <button id = 'submitTest1' type='button' class='btn btn-primary'>Submit</button>"+
            "      </div>"+
            "    </div>"+
            "  </div>"
        ...
        $('#closeLevel1').bind('click',function(){
            $(location).attr('href','index.html')
        })
        $('#triggerQuiz').click()
        
        $.ajax({
            url : 'http://127.0.0.1:5000/loadQ1',
            data : {},
            dataType : 'json',
            type : 'POST',
...
"</br>"
        ...
        $('#submitTest1').bind('click',function(){
            ...
            $.ajax({
                ...
                success : function(result){
                    ...
                    $('#final').append("your mark for this quiz is "+mark+" %")
                    $.ajax({
